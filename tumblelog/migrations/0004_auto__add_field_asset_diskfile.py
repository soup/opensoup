...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Asset.diskfile'
        db.add_column('tumblelog_asset', 'diskfile',
                      self.gf('django.db.models.fields.files.FileField')(default='404', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Asset.diskfile'
        db.delete_column('tumblelog_asset', 'diskfile')
    ...
    models = {
        ...
        'tumblelog.asset': {
            ...
            'diskfile': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
