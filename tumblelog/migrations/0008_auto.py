...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tumblelog_userprofile_following', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['tumblelog.userprofile'], null=False)),
            ('blog', models.ForeignKey(orm['tumblelog.blog'], null=False))
        ))
        db.create_unique('tumblelog_userprofile_following', ['userprofile_id', 'blog_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('tumblelog_userprofile_following')
