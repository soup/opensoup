...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.asset'
        db.alter_column('tumblelog_post', 'asset_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tumblelog.Asset'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Post.asset'
        raise RuntimeError("Cannot reverse this migration. 'Post.asset' and its values cannot be restored.")
