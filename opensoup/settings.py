...
STATIC_ROOT = '/tmp/opensoup-static/'
...
SITE_URL = 'localsoup.lutoma.org:8000'
AUTH_PROFILE_MODULE = 'tumblelog.UserProfile'
SESSION_COOKIE_DOMAIN='.' + SITE_URL.split(':')[0]
...
SECRET_KEY = '8il68!u#q)(xeic*8ev)^oke9(p+)n)7is3akhvpua#h%%%-dz'
